// Command delegatorgen generates delegator code for interfaces.
package main
...
import (
	...
	"github.com/tlipoca9/devgen/cmd/delegatorgen/generator"
...
func rootCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "delegatorgen [packages]",
		Short:   "Generate delegator code for interfaces",
...
func run(_ *cobra.Command, args []string) error {
	...
	if len(files) == 0 {
		log.Warn("No interfaces with @delegator found")
		return nil
	}
